...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "HTCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"vixor.nl", "dnsseed.vixor.nl"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"vixor.nl", "testnet-seed.vixor.nl"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. HTCoin is probably already running."), addrBind.ToString().c_str());
        else
